...
macos() {
    ...
    ############################################
    bot "Terminal & iTerm2 Configuration"
    ############################################
    ...
    ############################################
    bot "Time Machine Configuration"
    ############################################
    ...
    ############################################
    bot "Activity Monitor Configurations"
    ############################################
    ...
    ############################################
    bot "Address Book, Dashboard, iCal, TextEdit, and Disk Utility Configuration"
    ############################################
    ...
    ############################################
    bot "Mac App Store Configuration"
    ############################################
